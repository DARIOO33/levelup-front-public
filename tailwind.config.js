  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'wave':         'waveAnim 1.2s ease-in-out infinite',
        'orbit':        'orbitSpin 8s linear infinite',
      },
      keyframes: {
        float:         { '0%,100%': { transform: 'translateY(0px)' }, '50%': { transform: 'translateY(-12px)' } },
        pulseGlow:     { '0%,100%': { boxShadow: '0 0 20px rgba(124,58,255,0.4)' }, '50%': { boxShadow: '0 0 50px rgba(124,58,255,0.8),0 0 100px rgba(124,58,255,0.3)' } },
        ...
        waveAnim:      { '0%,100%': { transform: 'scaleY(0.3)' }, '50%': { transform: 'scaleY(1)' } },
